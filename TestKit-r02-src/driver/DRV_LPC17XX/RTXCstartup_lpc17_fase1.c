...
#define CRP1_MAGIC      0x12345678		// Protect low code part
#define CRP2_MAGIC      0x87654321		// Protect all code
#define CRP3_MAGIC      0x43218765		// Protect all code and disable debug serial (P2.10 at 0 from output)
/**** DANGER CRP3 WILL LOCK PART TO ALL READS and WRITES ****/
/*********** #define CRP3_MAGIC xxxx 0x43218765 *************/

//#define CURRENT_CRP_SETTING CRP2_MAGIC
#define CURRENT_CRP_SETTING CRP3_MAGIC
