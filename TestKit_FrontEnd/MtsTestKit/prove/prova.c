...
Rel  3.74 - 16/05/23  Aggiunto Rimozione Caratteri non alfanumerici in lettura file ASCII
*/ 
...
int GetIntStr(char *Delim, char *sInput,  unsigned int order, char *sOut){
    ...
    strncpy(cpIn,sInput,strlen(sInput));
